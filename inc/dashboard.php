...
function screenr_admin_notice() {
    ...
    if ( $number_action > 0 ) {
        ...
        <div class="updated notice is-dismissible">
            <p><?php printf( __( 'Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our <a href="%2$s">Welcome page</a>', 'screenr' ),  $theme_data->Name, admin_url( 'themes.php?page=ft_screenr' )  ); ?></p>
        </div>
        <?php
    }
}
...
function screenr_theme_info_page() {
    ...
    <div class="wrap about-wrap theme_info_wrapper">
        ...
        <div class="about-text"><?php esc_html_e( 'Screenr is a creative and flexible WordPress ONE PAGE theme well suited for business, portfolio, digital agency, product showcase, freelancers websites.', 'screenr' ); ?></div>
                ...
                <div class="theme_info_column clearfix">
                    <div class="theme_info_left">
                        ...
                        <div class="theme_link">
                            ...
                            <p>
                                <a href="<?php echo esc_url( 'http://docs.famethemes.com/category/42-screenr' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Screenr Documentation', 'screenr'); ?></a>
                            </p>
        ...
        <?php if ( $tab == 'actions_required' ) { ?>
            <div class="action-required-tab info-tab-content">
                ...
                <?php  } else { ?>
                    <h3><?php  printf( __( 'Keep update with %s', 'screenr' ) , $theme_data->Name ); ?></h3>
                    <p><?php _e( 'Hooray! There are no required actions for you right now.', 'screenr' ); ?></p>
                <?php } ?>
            </div>
        <?php } ?>

        <?php do_action( 'screenr_more_tabs_details', $actions ); ?>
