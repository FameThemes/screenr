                    ...
                    <div class="row">
                        ...
                        foreach (( array )$items as $item) {
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-<?php echo esc_attr($layout); ?>">
                                <div
                                    class="counter-item counter-item-<?php echo esc_attr($item['style']); ?>" <?php if ($item['bg_color']) { ?> style="background-color: #<?php echo esc_attr(str_replace('#', '', $item['bg_color'])); ?>" <?php } ?>>
